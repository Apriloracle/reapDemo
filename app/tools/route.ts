...
const MANIFEST = {
  ...
  accepts: [
    {
      ...
      resource: 'https://reap.deals/tools',
      ...
      outputSchema: {
        ...
        output: {
            // Define the expected output structure from the discovery engine
        },
      },
      extra: {
        provider: 'REAP',
  ...
  meta: {
    ...
    description: 'Real-time, personalized product search powered by a live client agent.',
