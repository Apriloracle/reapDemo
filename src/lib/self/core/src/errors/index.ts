...
export { RegistryContractError } from './RegistryContractError.ts';
export { VerifierContractError } from './VerifierContractError.ts';
export { ProofError } from './ProofError.ts';
