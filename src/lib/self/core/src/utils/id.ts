import { discloseIndices, revealedDataIndices } from './constants.ts';
import { AttestationId, GenericDiscloseOutput } from '../types/types.ts';
import { getRevealedDataBytes } from './proof.ts';
